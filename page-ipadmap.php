  ...
  <section role="main" class="content-primary" id="content-primary">
    <div class="container" style="padding:0;width:100%">
      <div class="row" style="margin:0;">
        <section class="col-xs-12 content-section content" style="padding-top:0;">
